import atividades from "../assets/icons/atividades.png";
import descontracao from "../assets/icons/descontracao.png";
import qualidade from "../assets/icons/qualidade.png";
...
export const staffPhotos = [
  {
    src: camila,
    alt: "Mulher sorrindo para a câmera, longos cabelos escuros, brincos de argola e camiseta preta"
  },
  {
    src: guto,
    alt: "Homem sorrindo olhando para a câmera, com cabelos pretos lisos, terno preto e camisa branca"
  },
  {
    src: david,
    alt: "Homem olhando para a câmera, usando óculos de grau com estantes de livros ao fundo"
  },
  {
    src: beatriz,
